...
class Financial_liabModel:
    def  __init__(self):
        self.filepath = r"D:\MFSC_PROGRAM\UAT\MFSC_APP\asset\finacial_liab_template.xlsx"
        self.data = None
    ...
    def export_data(self):
        ...
        export_columns = ['REF_NO','EFFECTIVE_DATE','COMP_CODE','NET_LIAB','USER_UPLOAD','UPLOAD_DATE','DELETE_FLAG']
        try:
